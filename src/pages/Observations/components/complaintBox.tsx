        ...
        <DialogContent>
          <DialogContentText className='w-full'>
            ...
            <div className='w-full flex text-md mb-3'>
                ...
                <span className='!w-3/6'><SelectField className="w-full" fieldClassName="" label={"Select Geofence"} handleChange={handleSelectReason} value={formData?.reason} options={reasonsArray} objKey="group" /></span>
            </div>
            <div className='w-full flex text-md mb-3'>
