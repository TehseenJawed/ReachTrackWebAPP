...
import { createTyreMaintenance, getMaintenanceData } from '../../../redux/actions/trackActions';
...
const steps = ['Current Mileage', 'Tyre Change', 'Change Due', 'Reminder', 'Remarks', "Summary"];

export default function ChangeTyreForm({ open, setOpen, vehicle }) {
    ...
    const handleLoad = async () => {
        ...
        // @ts-ignore
        await dispatch(createTyreMaintenance(newObj, (message, variant) => enqueueSnackbar(message, { variant: variant })))

        // @ts-ignore
        await dispatch(getMaintenanceData((message, variant) => enqueueSnackbar(message, { variant: variant }), vehicle?.id))
        handleClose()
    }
            ...
            case step === 5:
                return (
                    <div className='w-full border border-black'>
                        ...
                        <div className='w-full bg-bgColor text-black text-center font-semibold p-1 border border-black'>Tyre Change</div>
                        <div className='flex'>
    ...
    return (
        <React.Fragment>
            ...
            >
                <DialogTitle className='w-[400px]'>Change Tyre</DialogTitle>
